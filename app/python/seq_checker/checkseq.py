...
def run_checker():
    ...
    rmtree("%s/GOOD" % html_output_folder, ignore_errors=True)
    rmtree("%s/BAD" % html_output_folder, ignore_errors=True)
    os.system('mv "%s/GOOD" "%s"' % (output_folder, html_output_folder))
    os.system('mv "%s/BAD" "%s"' % (output_folder, html_output_folder))
    os.system('mv "%s/*.html" "%s"' % (output_folder, html_output_folder))
